...
import type { TemplateCardsBlock } from '@payload-types'

import { ArrowIcon } from '@icons/ArrowIcon'

import classes from './index.module.scss'

type TemplateCardType = NonNullable<
  Pick<TemplateCardsBlock, 'templates'>['templates']
>[0]
...
export const TemplateCards: React.FC<{ templates: TemplateCardType[] }> = (
  props
) => {
