  ...
  return (
    <div
      ...
      className={[
        classes.wrapper,
        className,
        enableBorders && classes.enableBorders
      ]
        .filter(Boolean)
        .join(' ')}
      style={style}
    >
      <div
        className={[classes.backgroundScanline].filter(Boolean).join(' ')}
      ></div>
      {crosshairs && (
        <>
