...
> = ({
  ...
  useEffect(() => {
    ...
    return () =>
      window.removeEventListener('resize', updateMobileMediaWrapperHeight)
  }, [])
            ...
            <div className={classes.imagesContainerWrapper}>
              ...
              {typeof featureVideo === 'object' && featureVideo !== null && (
                <div
                  ...
                  style={{ height: laptopMediaHeight }}
                >
                  <Media
          ...
          <div className={classes.contentWrapper} style={contentWrapperHeight}>
            <Gutter className={classes.content}>
              <div className={classes.primaryContentWrap} data-theme="dark">
                ...
                <div
                  className={[classes.primaryContent, 'grid']
                    .filter(Boolean)
                    .join(' ')}
                >
                  <div className={['cols-8 start-1'].filter(Boolean).join(' ')}>
                    ...
                    <RichText
                      className={classes.richTextHeading}
                      content={richText}
                    />
                    <RichText
              ...
              <div
                data-theme="dark"
                className={[classes.secondaryContentWrap, 'grid']
                  .filter(Boolean)
                  .join(' ')}
              >
                <BackgroundGrid
                  className={classes.mobileSecondaryBackgroundGrid}
                  zIndex={1}
                />
                <div className={classes.mobileSecondaryBackground} />
                <div
                  className={[classes.secondaryContent, 'cols-8 start-1']
                    .filter(Boolean)
                    .join(' ')}
                >
                  <RichText
