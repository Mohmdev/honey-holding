...
export const CookieClientPage: React.FC = () => {
  const [trackingCookies, setTrackingCookies] = React.useState<string | null>(
    null
  )
      ...
      <Gutter className={classes.cookieWrap}>
        <div className="grid">
          <div className="cols-12 cols-m-8">
            ...
            <p>
              This cookie policy explains how Nexweb CMS, Inc. and our
            ...
            <p>
              ...
              use, who may also use cookies as part of their service. If you
              don’t wish to accept cookies from us or from third-parties on
              which we rely, please let us know by rejecting all or some
              categories of cookies via the cookie banner that is displayed to
              you when you visit our Sites. In such a case, we may be unable to
            ...
            <p>
              ...
              website itself, a unique identifier that allows the website to
            ...
            <p>
              ...
              websites that use the same third-party service. We use third party
              cookies on our Sites.
            </p>
            <h3>Types of cookies and how we use them</h3>
            <h4>Strictly necessary cookies</h4>
            <p>
              Strictly necessary cookies are crucial to your experience of a
              website, enabling core features like user logins, account
              management, shopping carts, and payment processing. These cookies
              are necessary for the Sites to function and cannot be switched off
              in our systems.
            </p>
            <p>
              We use strictly necessary cookies to enable certain functions on
              our Sites.
            </p>
            <h4>Performance cookies</h4>
            <p>
              Performance cookies track how you use a website during your visit.
              Typically, this information is aggregated, with information
              tracked across all Sites users. They help companies understand
              visitor usage patterns, identify and diagnose problems or errors
              their users may encounter, and make better strategic decisions in
              improving their audience’s overall website experience. These
              cookies may be set by the website you’re visiting (first-party
              cookie) or by third-party services.
            </p>
            <p>We use performance cookies on our Sites.</p>
            <h4>Functional cookies</h4>
            <p>
              Functional cookies are used to collect information about your
            ...
            <h4>
              What types of cookies and similar tracking technologies do we use
              on the Sites?
            </h4>
            <p>
              On the Sites, we use cookies and other tracking technologies
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      your use of our Sites by downloading and installing a
                  ...
                  <tr>
                    <td>_gcl_au</td>
                    <td>
                      Targeting/advertising: to store and track conversions.
                    </td>
                    <td>1 year after the user’s visit</td>
                    <td>Google</td>
                    <td>
            ...
            <p>
              ...
              as Flash technology to pixel tags to collect information
              automatically.
            </p>
            ...
            <p>
              ...
              Shared Object (“Flash LSOs”)) on our Sites to collect and store
              information about your use of our Sites. Unlike other cookies,
              Flash cookies cannot be removed or rejected via your browser
              settings. If you do not want Flash LSOs stored on your computer or
              mobile device, you can adjust the settings of your Flash player to
              block Flash LSO storage using the tools contained in the Website
              Storage Settings Panel. You can also control Flash LSOs by going
              to the Global Storage Settings Panel and following the
              instructions. Please note that setting the Flash Player to
              restrict or limit acceptance of Flash LSOs may reduce or impede
              the functionality of some Flash applications, including,
              potentially, Flash applications used in connection with our Sites.
            </p>
            <h5>Web Beacons.</h5>
            <p>
              We may also use web beacons (which are also known as pixel tags
              and clear GIFs) on our Sites and in our HTML formatted emails to
              ...
              compile statistics about usage of the Sites, so that we can manage
              our content more effectively.
            </p>
            <h4>Your choices</h4>
            <p>
              You can decide not to accept cookies or other technologies. If you
              do not accept our cookies or other technologies, you may
              experience some inconvenience in your use of our Sites. For
            ...
            <p>
              You can change the cookie settings when you visit our Sites via
              our cookie banner that is displayed to you when you first visit
              our Sites, or at any time by visiting the cookie preferences
              below. Our cookie banner and cookie preference center allow you to
            ...
            <ul>
              ...
              <li>
                ...
                button (i.e. “accept all”, “reject all” or “manage my
                settings”).
              </li>
            </ul>
            ...
            <p>
              ...
              cookies by default until you change your settings. In order to
            ...
            <p>
              ...
              prevent images from loading. To do this, follow the instructions
            ...
            <p>
              You may opt out of receiving interest-based advertising on
              websites through members of the Network Advertising Initiative by
              clicking{' '}
              <a href="https://optout.networkadvertising.org/?c=1">here</a> or
              the Digital Advertising Alliance by clicking{' '}
              <a href="https://optout.aboutads.info/?c=2&lang=EN">here</a>.
              Please note that we also may work with companies that offer their
              own opt-out mechanisms and may not participate in the opt-out
              mechanisms linked above.
            </p>
            <p>
              If you do not accept our cookies, you may experience some
              inconvenience in your use of our Sites. For example, we may not be
              able to recognize your computer or mobile device and you may need
              to log in every time you visit our Sites.
            </p>
            <p>
          ...
          <div className="cols-16 cols-m-8">
            ...
            <p>
              ...
              functionality of our website. Your decision to either accept or
              decline the use of cookies may impact your overall experience with
              our site and the services we can offer. By clicking the ENABLED
              button, you provide your consent to our use of all categories of
              cookies on our site. Similarly, by clicking the DISABLED button,
              you choose to restrict our use of cookies during your visit.
            </p>
            <FormComponent>
              <RadioGroup
