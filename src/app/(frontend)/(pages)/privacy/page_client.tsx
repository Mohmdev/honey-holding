      ...
      <Gutter className={classes.privacyWrap}>
        <div className="grid">
          <div className="cols-12 cols-m-8">
            ...
            <p>
              This Privacy Policy describes how Payload CMS, Inc. (&quot;
              <b>Payload</b>,&quot; &quot;<b>we</b>&quot;, “<b>us</b>” or &quot;
              ...
              and other activities described in this Privacy Policy
              (collectively, the “<b>Service</b>”)).
            </p>
            <p>
              Our websites, products and services are designed for enterprise
              customers and their representatives. We do not offer products or
              services for use by individuals for their personal, family or
              household purposes. Accordingly, we treat all personal information
              we collect as pertaining to individuals in their capacities as
              representatives of the relevant enterprise and not their
              individual capacities.
            </p>
            <p>
              NOTICE TO EUROPEAN USERS: Please see the{' '}
              <a href="#EuropeanUsers">Notice to European Users</a> section for
              additional information for individuals located in the European
              Economic Area or United Kingdom (which we refer to as “
            ...
            <ul>
              <li>
                <b>Contact data</b>, such as your first and last name,
                salutation, email address, billing and mailing addresses,
                professional title and company name, and phone number.
              </li>
              <li>
                <b>Demographic data</b>, such as your city, state, country of
                residence, and postal code.
              </li>
              <li>
                <b>Profile data</b>, such as the username and password that you
                may set to establish an online account on the Service,
                redemption code, and any other information that you add to your
                account profile.
              </li>
              <li>
              ...
              <li>
                ...
                needed to complete your orders on or through the Service,
                including order numbers and transaction history.
              </li>
              <li>
              ...
              <li>
                <b>Payment data</b> needed to complete transactions, including
                payment card information or bank account number.
              </li>
              <li>
            ...
            <ul>
              ...
              <li>
                <b>Our affiliate partners</b>, such as our affiliate network
                provider and publishers, influencers, and promoters who
                participate in our paid affiliate programs.
              </li>
              <li>
                <b>Third-party services</b>, such as third-party services that
                you use to log into, or otherwise link to, your Service account.
            ...
            <ul>
              ...
              <li>
                <b>Activity data</b>, such as pages or screens you viewed, how
                ...
                access times and duration of access, and utilization of the
                Services (including server utilization, file and database
                storage activity, and mail transport volume).
              </li>
              <li>
                <b>Precise geolocation data</b> when you authorize the Service
                to access your device’s location.
              </li>
              <li>
                <b>Communication interaction data</b> such as your interactions
                with our email, text or other communications (e.g., whether you
                open and/or forward emails) – we may do this through use of
            ...
            <p>
              ...
              information, see our Cookie Notice. We will also store a record of
              your preferences in respect of the use of these technologies in
              connection with the Service.
            </p>
            <p>
              <b>Data about others</b>. We may offer features that help users
              invite their contacts to use the Service, and we may collect
              contact details about these invitees so we can deliver their
              invitations. Please do not refer someone to us or share their
              contact details with us unless you have their permission to do so.
            </p>
            ...
            <ul>
              ...
              <li>
                facilitate your invitations to contacts who you want to invite
                to join the Service;
              </li>
              <li>
            ...
            <p>
              <b>Marketing and advertising</b>. We, our third-party advertising
              partners and our service providers may collect and use your
            ...
            <ul>
              ...
              <li>
                <b>Interest-based advertising</b>. Our third-party advertising
                partners may use cookies and similar technologies to collect
                information about your interaction (including the data described
                in the automatic data collection section above) with the
                Service, our communications and other online services over time,
                and use that information to serve online ads that they think
                will interest you. This is called interest-based advertising. We
                may also share information about our users with these companies
                to facilitate interest-based advertising to those or similar
                users on other online platforms. You can learn more about your
                choices for limiting interest-based advertising in the Your
                choices section of our Cookie Notice.
              </li>
            </ul>
            ...
            <p>
              ...
              We may create aggregated, de-identified and/or anonymized data
              from your personal information and other individuals whose
              personal information we collect. We make personal information into
              de-identified and/or anonymized data by removing information that
              makes the data identifiable to you. We may use this aggregated,
              de-identified and/or anonymized data and share it with third
            ...
            <p>
              <b>Payment processors</b>. Any payment card information you use to
              make a purchase on the Service is collected and processed directly
              by our payment processors, such as Stripe. Stripe may use your
              payment data in accordance with its privacy policy,{' '}
            ...
            <p>
              ...
              the interest-based advertising purposes described above.
            </p>
            <p>
              <b>Third parties designated by you</b>. We may share your personal
              information with third parties where you have instructed us or
              provided your consent to do so. We will share personal information
              that is needed for these other companies to provide the services
              that you have requested.
            </p>
            <p>
              <b>Business and marketing partners</b>. Third parties with whom we
              jointly offer products or services, or whose products or services
              may be of interest to you.
            </p>
            <p>
              <b>Linked third-party services</b>. If you log into the Service
              with, or otherwise link your Service account to, a third-party
              service, we may share your personal information with that
              third-party service. The third party’s use of the shared
              information will be governed by its privacy policy and the
              settings associated with your account with the third-party
              service.
            </p>
            <p>
            ...
            <p>
              ...
              (e.g., investments in Payload, financing of Payload, public stock
              offerings or the sale, transfer or merger of all or part of our
              business, assets or shares), for example, we may need to share
              certain personal information with prospective counterparties and
              their advisers. We may also disclose your personal information to
              an acquirer, successor or assignee of Payload as part of any
              merger, acquisition, sale of assets, or similar transaction and/or
            ...
            <p>
              ...
              all users. Users who are located in Europe can find additional
              information about their rights below.
            </p>
            <p>
              <b>Access or update your information</b>. If you have registered
              for an account with us through the Service, you may review and
            ...
            <p id="optOut">
              ...
              <a href="#contactUs">contacting us</a>. Please note that if you
            ...
            <p>
              ...
              Service and how to control them, see our Cookie Notice.
            </p>
            <p>
            ...
            <p>
              <b>Advertising choices</b>. You may be able to limit use of your
              information for interest-based advertising through the following
              settings/options/tools:
            </p>
            <ul>
              <li>
                <b>Browser settings</b>. Changing your internet web browser
                settings to block third-party cookies.
              </li>
              <li>
                <b>Privacy browsers/plug-ins</b>. Using privacy browsers and/or
              ...
              <li>
                ...
                interest-based advertising. You may be able to exercise that
              ...
              <li>
                ...
                companies that participate in the following industry opt-out
                programs:
                <ul>
                  <li>
            ...
            <p>
              ...
              browser from which you wish to limit the use of your information
            ...
            <p>
              ...
              We currently do not respond to “Do Not Track” signals. To find out
            ...
            <p>
              ...
              the Service through a third-party platform, you may be able to use
              your settings in your account with that platform to limit the
              information we receive from it. If you revoke our ability to
              access information from a third-party platform, that choice will
              not apply to information that we have already received from that
              third party.
            </p>
            ...
            <p>
              ...
              are not responsible for their actions. We encourage you to read
              the privacy policies of the other websites, mobile applications
            ...
            <p>
              ...
              technologies, and we cannot guarantee the security of your
            ...
            <p>
              Users in Europe should read the important information provided
              below about transfer of personal information outside of Europe.
            </p>
            ...
            <p>
              ...
              prohibited by law, please <a href="#contactUs">contact us</a>. If
              we learn that we have collected personal information through the
              Service from a child without the consent of the child’s parent or
            ...
            <h5>General</h5>
            <p>
              <b>Where this Notice to European users applies</b>. The
              information provided in this “Notice to European users” section
              applies only to individuals in the United Kingdom and the European
              Economic Area (i.e., “<b>Europe</b>” as defined at the top of this
              Privacy Policy).
            </p>
            <p>
              <b>Personal information</b>. References to “personal information”
              in this Privacy Policy should be understood to include a reference
              to “personal data” (as defined in the GDPR) – i.e., information
              about individuals from they are either directly identified or can
              be identified.{' '}
            </p>
            <p>
              <b>Controller</b>. Payload CMS, Inc. (“<b>Payload</b>”) is the
              controller in respect of the processing of your personal
              information covered by this Privacy Policy for purposes of
              ...
              ’ (as and where applicable, the “<b>GDPR</b>”)). See the ‘How to
              contact us’ section above for our contact details.
            </p>
            <h5>General Data Protection Regulation (GDPR)</h5>
            <p>
              <b>European Representative</b>. Pursuant to Article 27 of the
              General Data Protection Regulation (GDPR), Payload CMS, Inc. has
              appointed European Data Protection Office (EDPO) as its GDPR
              Representative in the EU. You can contact EDPO regarding matters
            ...
            <p>
              <b>UK Representative</b>. Pursuant to Article 27 of the UK GDPR,
              Payload CMS, Inc. has appointed EDPO UK Ltd as its UK GDPR
              representative in the UK. You can contact EDPO UK regarding
              matters pertaining to the UK GDPR:
              <ul>
                <li>
                  by using EDPO’s online request form:{' '}
                  <a
                    href="https://edpo.com/uk-gdpr-data-request/"
                    target="_blank"
                  >
                    https://edpo.com/uk-gdpr-data-request
                  </a>
                ...
                <li>
                  by writing to EDPO UK at 8 Northumberland Avenue, London WC2N
                  5BY, United Kingdom
                </li>
              </ul>
            </p>
            ...
            <p>
              Our legal bases for processing your personal information described
              in this Privacy Policy are listed below.
            </p>
            <ul>
              <li>
                Where we need to perform a contract, we are about to enter into
                or have entered into with you (“<b>Contractual Necessity</b>”).
              </li>
              <li>
              ...
              <li>
                ...
                for the purpose in question (“<b>Consent</b>&quot;).
              </li>
            </ul>
            <p>
              We have set out below, in a table format, the legal bases we rely
              on in respect of the relevant purposes for which we use your
              personal information – for more information on these purposes and
              the data types involved, see ‘How we use your personal
              information’.
            </p>
              ...
              <table>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      Legitimate interest. We have legitimate interest, and
                      believe it is also in your interests, that we are able to
                      take steps to ensure that our services and how we use
                      personal information is as un-privacy intrusive as
                      possible.
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <p>
                        ...
                        promoting our operations and goals as an organization
                        and sending marketing communications for that purpose.
                      </p>
                      <p>
                        Consent, in circumstances or in jurisdictions where
                        consent is required under applicable data protection
                        laws to the sending of any given marketing
                        communications.
                      </p>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <p>
                        Legitimate Interests. We have a legitimate interest in
                        understanding better your interests to enhance and
                        personalize your experience while using our Service.
                      </p>
                      <p>
                        Consent, in circumstances or in jurisdictions where
                        consent is required under applicable data protection
                        laws to personalize the users’ experience.
                      </p>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      ...
                      <p>
                        Legitimate interest. Where Compliance with Law is not
                        applicable, we and any relevant third parties have a
                        legitimate interest in participating in, supporting, and
                        following legal process and requests, including through
                        co-operation with authorities. We and any relevant third
                        parties may also have a legitimate interest of ensuring
                        the protection, maintenance, and enforcement of our and
                        their rights, property, and/or safety.
                      </p>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <p>
                        The original legal basis relied upon, if the relevant
                        further use is compatible with the initial purpose for
                        which the personal information was collected.
                      </p>
                      <p>
                        Consent, if the relevant further use is not compatible
                        with the initial purpose for which the personal
            ...
            <h5>Other info</h5>
            <p>
              <b>No sensitive personal information</b>. We ask that you not
              ...
              political opinions, religion or other beliefs, health, or genetic
              characteristics, criminal background or trade union membership) on
              or through the Service, or otherwise to us. If you provide us with
              any sensitive personal information to us when you use the Service,
            ...
            <h5>Your rights</h5>
            <p>
              <b>General</b>. European data protection laws give you certain
              rights regarding your personal information. If you are located in
              Europe, you may ask us to take the following actions in relation
            ...
            <ul>
              ...
              <li>
                <b>Delete</b>. Delete your personal information where there is
                no lawful reason for us continuing to store or process it, where
                ...
                personal information to comply with local law. Note, however,
                that we may not always be able to comply with your request of
                erasure for specific legal reasons that will be described to
                you, if applicable, at the time of your request.
              </li>
              <li>
                <b>Portability</b>. Port a machine-readable copy of your
                personal information to you or a third party of your choice, in
                certain circumstances. Note that this right only applies to
                automated information for which you initially provided consent
                for us to use or where we used the information to perform a
                contract with you.
              </li>
              <li>
                <b>Restrict</b>. Restrict the processing of your personal
                information, if, (i) you want us to establish the personal
                information&apos;s accuracy; (ii) where our use of the personal
                information is unlawful but you do not want us to erase it;
                (iii) where you need us to hold the personal information even if
                we no longer require it as you need it to establish, exercise or
                defend legal claims; or (iv) you have objected to our use of
                your personal information but we need to verify whether we have
                overriding legitimate grounds to use it.
              </li>
              <li>
                <b>Object</b>. Object to our processing of your personal
                information where we are relying on Legitimate Interests (or
                ...
                and freedom – you also have the right to object where we are
                processing your personal information for direct marketing
                purposes.
              </li>
              <li>
                <b>Withdraw Consent</b>. When we use your personal information
                based on your consent, you have the right to withdraw that
                consent at any time. This will not affect the lawfulness of any
                processing carried out before you withdraw your consent.
              </li>
            </ul>
            <p>
              <b>Exercising These Rights</b>. You may submit these requests by
              email to [legal@payloadcms.com] or our postal address provided
              above. We may request specific information from you to help us
              confirm your identity and process your request. Whether or not we
              are required to fulfill any request you make will depend on a
              number of factors (e.g., why and how we are processing your
              personal information), if we reject any request you may make
              (whether in whole or in part) we will let you know our grounds for
              doing so at the time, subject to any legal restrictions.
            </p>
            <p>
              <b>
              ...
              process your personal information, you can make a complaint to the
            ...
            <p>
              ...
              advisers, partners or other recipients of data are also based in
              the U.S. This means that, if you use the Service, your personal
              information will necessarily be accessed and processed in the U.S.
              It may also be provided to recipients in other countries outside
              Europe.
            </p>
            <p>
              It is important to note that that the U.S. is not the subject of
              an ‘adequacy decision’ under the GDPR – basically, this means that
              the U.S. legal regime is not considered by relevant European
              bodies to provide an adequate level of protection for personal
              information, which is equivalent to that provided by relevant
              European laws.
            </p>
            <p>
              Where we share your personal information with third parties who
              are based outside Europe, we try to ensure a similar degree of
              protection is afforded to it by making sure one of the following
              mechanisms is implemented:
            </p>
            <ul>
              <li>
                <b>Transfers to territories with an adequacy decision</b>. We
                may transfer your personal information to countries or
                territories whose laws have been deemed to provide an adequate
                level of protection for personal information by the European
                Commission or UK Government (as and where applicable) (from time
                to time).
              </li>
              <li>
                ...
                <ul>
                  <li>
                    ...
                    territories whose laws have <b>not</b> been deemed to
                    provide such an adequate level of protection (e.g., the
                    U.S., see above).
                  </li>
                  <li>
                    ...
                    <ul>
                      <li>
                        we may use specific appropriate safeguards, which are
                        designed to give personal information effectively the
                        same protection it has in Europe – for example,
                        standard-form contracts approved by relevant authorize
                        for this purpose; or
                      </li>
                      <li>
                        in limited circumstances, we may rely on an exception,
                        or ‘derogation’, which permits us to transfer your
                        personal information to such country despite the absence
                        of an ‘adequacy decision’ or ‘appropriate safeguards’ –
                        for example, reliance on your explicit consent to that
                        transfer.
                      </li>
                    </ul>
                  </li>
