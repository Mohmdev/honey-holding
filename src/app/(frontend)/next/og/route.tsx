...
export async function GET(req: NextRequest): Promise<ImageResponse> {
  try {
    ...
    const untitledSansRegularFont = await fetch(
      new URL('src/lib/fonts/UntitledSans-Regular.woff', import.meta.url)
    ).then((res) => res.arrayBuffer())

    const untitledSansMediumFont = await fetch(
      new URL('src/lib/fonts/UntitledSans-Medium.woff', import.meta.url)
    ).then((res) => res.arrayBuffer())

    const robotoFont = await fetch(
      new URL('src/lib/fonts/RobotoMono-Regular.woff', import.meta.url)
    ).then((res) => res.arrayBuffer())
